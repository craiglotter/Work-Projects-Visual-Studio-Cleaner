    ...
    Private Sub backgroundWorker1_RunWorkerCompleted(ByVal sender As Object, ByVal e As RunWorkerCompletedEventArgs) Handles BackgroundWorker1.RunWorkerCompleted
        ...
        Else
            ...
            If AlertMessage.Length > 0 Then
                ...
                MsgBox(AlertMessage & " instances of bin and obj folders were removed", MsgBoxStyle.Information, "Objects Removed")
            End If
        End If
            ...
            If dinfo.Exists Then
                For Each subdir As DirectoryInfo In dinfo.GetDirectories
                    ...
                    If worker.CancellationPending Then
                        ...
                        Return False
                    End If
                    Dim subdirsource As DirectoryInfo = New DirectoryInfo((subdir.FullName & "\Source Code").Replace("\\", "\"))
                    If subdirsource.Exists = True Then
                        For Each subdir2 As DirectoryInfo In subdirsource.GetDirectories
                            If My.Computer.FileSystem.DirectoryExists((subdir2.FullName & "\bin").Replace("\\", "\")) = True Then
                                My.Computer.FileSystem.DeleteDirectory((subdir2.FullName & "\bin").Replace("\\", "\"), FileIO.UIOption.OnlyErrorDialogs, FileIO.RecycleOption.SendToRecycleBin, FileIO.UICancelOption.DoNothing)
                                If AlertMessage = "" Then
                                    AlertMessage = "0"
                                End If
                                AlertMessage = (Integer.Parse(AlertMessage) + 1).ToString
                            End If
                            If My.Computer.FileSystem.DirectoryExists((subdir2.FullName & "\obj").Replace("\\", "\")) = True Then
                                My.Computer.FileSystem.DeleteDirectory((subdir2.FullName & "\obj").Replace("\\", "\"), FileIO.UIOption.OnlyErrorDialogs, FileIO.RecycleOption.SendToRecycleBin, FileIO.UICancelOption.DoNothing)
                                If AlertMessage = "" Then
                                    AlertMessage = "0"
                                End If
                                AlertMessage = (Integer.Parse(AlertMessage) + 1).ToString
